...
class Space_object(pygame.sprite.Sprite): 
    ...
    def update_pos(self, dt: float, zoom: float, half_w: float, half_h: float): 
        """
    ...
    def update_rect(self, zoom, half_w, half_h): 
        """ 
...
def simulation_screen(camera_group: CameraGroup, simulation_time: int): 
    ...
    def seconds_to_days_and_seconds(seconds: float): 
        """
        funkjson som gjør om fra sekunder til string med antall dager og sekunder
        """
